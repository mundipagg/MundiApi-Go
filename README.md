...
```go
page,_ := strconv.ParseInt("16", 10, 8)
size,_ := strconv.ParseInt("16", 10, 8)
code := "code"
...
```go
page,_ := strconv.ParseInt("180", 10, 8)
size,_ := strconv.ParseInt("180", 10, 8)
name := "name"
status := "status"
billingType := "billing_type"
createdSince := time.Now()
...
var result *models_pkg.GetInvoiceResponse
result,_ = invoices.CreateInvoice(subscriptionId, cycleId, request)
...
```go
customerId := "customer_id"
page,_ := strconv.ParseInt("88", 10, 8)
size,_ := strconv.ParseInt("88", 10, 8)
...
```go
page,_ := strconv.ParseInt("130", 10, 8)
size,_ := strconv.ParseInt("130", 10, 8)
