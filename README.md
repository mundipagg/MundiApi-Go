...
result,_ = subscriptions.UpdateSubscriptionStartAt(subscriptionId, request)
...
```go
subscriptionId := "subscription_id"
page,_ := strconv.ParseInt("27", 10, 8)
size,_ := strconv.ParseInt("27", 10, 8)
name := "name"
code := "code"
status := "status"
...
var result *models_pkg.GetSubscriptionResponse
result,_ = subscriptions.UpdateSubscriptionDueDays(subscriptionId, request)
...
var result *models_pkg.GetSubscriptionResponse
result,_ = subscriptions.UpdateSubscriptionMiniumPrice(subscriptionId, request)
...
var result 
result,_ = subscriptions.UpdateCurrentCycleStatus(subscriptionId, request)
...
### <a name="remove_invoice_usage"></a>![Method: ](https://apidocs.io/img/method.png ".invoices_pkg.RemoveInvoiceUsage") RemoveInvoiceUsage
...
var result *models_pkg.GetInvoiceResponse
result,_ = invoices.RemoveInvoiceUsage(invoiceId, usageId)

```


### <a name="remove_invoice_usages"></a>![Method: ](https://apidocs.io/img/method.png ".invoices_pkg.RemoveInvoiceUsages") RemoveInvoiceUsages

> Remove usages from an invoice


```go
func (me *INVOICES_IMPL) RemoveInvoiceUsages(invoiceId string)(*models_pkg.GetInvoiceResponse,error)
```
...
var result *models_pkg.GetInvoiceResponse
result,_ = invoices.RemoveInvoiceUsages(invoiceId)
...
```go
customerId := "customer_id"
page,_ := strconv.ParseInt("68", 10, 8)
size,_ := strconv.ParseInt("68", 10, 8)
...
```go
customerId := "customer_id"
page,_ := strconv.ParseInt("232", 10, 8)
size,_ := strconv.ParseInt("232", 10, 8)
...
var result *models_pkg.GetCardResponse
result,_ = customers.RenewCard(customerId, cardId)
...
var result *models_pkg.GetChargeResponse
result,_ = charges.ConfirmPayment(chargeId, request)
...
var result *models_pkg.GetRecipientResponse
result,_ = recipients.UpdateRecipientTransferSettings(recipientId, request)
