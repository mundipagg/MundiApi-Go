...
```go
customerId := "customer_id"
page,_ := strconv.ParseInt("190", 10, 8)
size,_ := strconv.ParseInt("190", 10, 8)
...
subscriptionId := "subscription_id"
itemId := "item_id"
page,_ := strconv.ParseInt("148", 10, 8)
size,_ := strconv.ParseInt("148", 10, 8)
...
size,_ := strconv.ParseInt("240", 10, 8)
name := "name"
document := "document"
code := "code"
status := "status"
