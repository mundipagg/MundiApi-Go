...
```go
page,_ := strconv.ParseInt("246", 10, 8)
size,_ := strconv.ParseInt("246", 10, 8)
code := "code"
...
```go
subscriptionId := "subscription_id"
page,_ := strconv.ParseInt("40", 10, 8)
size,_ := strconv.ParseInt("40", 10, 8)
...
```go
page,_ := strconv.ParseInt("223", 10, 8)
size,_ := strconv.ParseInt("223", 10, 8)
name := "name"
document := "document"
code := "code"
status := "status"
