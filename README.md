...
```go
page,_ := strconv.ParseInt("48", 10, 8)
size,_ := strconv.ParseInt("48", 10, 8)
code := "code"
...
```go
customerId := "customer_id"
page,_ := strconv.ParseInt("6", 10, 8)
size,_ := strconv.ParseInt("6", 10, 8)
...
result,_ = customers.GetCustomers(code, name, document, page, size, email)
