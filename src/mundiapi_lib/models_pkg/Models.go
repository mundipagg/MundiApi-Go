...
/*
 * Structure for the custom type GetSubscriptionUsagesDetailsResponse
 */
type GetSubscriptionUsagesDetailsResponse struct {
    ...
    Usages          []*GetUsageResponse `json:"Usages" form:"Usages"` //Usages Details
}
