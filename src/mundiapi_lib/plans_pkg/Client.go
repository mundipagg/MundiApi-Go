...
func (me *PLANS_IMPL) CreatePlanItem (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.PlansItemsResponse = &models_pkg.PlansItemsResponse{}
...
func (me *PLANS_IMPL) GetPlans (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models_pkg.PlansResponse = &models_pkg.PlansResponse{}
    err = json.Unmarshal(_response.RawBody, &retVal)
...
func (me *PLANS_IMPL) GetPlan (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models_pkg.PlansResponse1 = &models_pkg.PlansResponse1{}
    err = json.Unmarshal(_response.RawBody, &retVal)
...
func (me *PLANS_IMPL) UpdatePlanMetadata (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models_pkg.PlansMetadataResponse = &models_pkg.PlansMetadataResponse{}
    err = json.Unmarshal(_response.RawBody, &retVal)
